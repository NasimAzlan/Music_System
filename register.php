...
<body>
    <div id="background">
        <div id="loginContainer">
            <div id="inputContainer">
                ...
                <form action="register.php" id="registerForm" method="POST">
                    ...
                    <p>
                        ...
                        <input type="text" id="username" name="username" placeholder="Enter User name" value="<?php getInputValue("username") ?>" required>
                    </p>
                    <p>
                        <?php
            ...
            <div id="loginText">
                <img src="assets/images/Icons/logo1.webp" alt="Logo">
                <h1>Music Zone</h1>
